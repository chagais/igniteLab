                ...
                <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-6">
                        <img 
                            ...
                            src="https://github.com/chagais.png" 
                            alt="avatar" 
                        />
                        <div className="leading-relaxed">
                            <strong className="font-bold text-2xl block">Tiago Oliveira</strong>
                            <span className="text-gray-200 text-sm block">CTO @BitInfotech</span>
                        </div>
                    </div>
                </div>
